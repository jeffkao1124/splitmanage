...
document.getElementById("simplehref").innerHTML ="轉為不簡化結算";
...
document.getElementById("simplehref").innerHTML ="轉為簡化結算";
...
<script type="text/javascript">
function divSShow(){
document.getElementById("explainshow").style.display="block";
document.getElementById("explainhref").innerHTML ="隱藏說明";
document.getElementById("explainhref").href ="javascript:divhhidden()";
}
function divhhidden(){
document.getElementById("explainshow").style.display="none";
document.getElementById("explainhref").innerHTML ="Q : 什麼是簡化結算?";
document.getElementById("explainhref").href ="javascript:divSShow()"; 
}
</script>
...
<div align="center">
    ...
    <a href="javascript:div_show();" id="simplehref">轉為簡化結算</a>
    </p>
    ...
    {% endfor %}
       ...
       <a href="javascript:divSShow();" id="explainhref" style="text-align:left;">Q : 什麼是簡化結算?</a>
    <div style="display: none;" id="explainshow">
    <!-- <p style="text-align:left;"><strong>Q : 什麼是簡化結算?</strong></p> -->
    <p style="text-align:left;"><strong>A : 簡化結算能夠自動將群組中的債務結合起來。</strong></p>
    <p style="text-align:left;">如下圖所示 : </p>
    <img src="https://imgur.com/TNJOwwD.png" style="width:240px;height:auto;"></img>
    <p style="text-align:left;">假設鳥A原本必須先將1000元交給鳥B，鳥B再將1000元交給C；若使用簡化結算，則會顯示鳥A直接將1000元交給C</p>
    </div>
</div>
<br/>
    <p align="left" style="background-color:#fff9c4;font-size:20px;text-align: left;"><strong> &nbsp應收/應付</strong></p>
  ...
  <div style="width:350px;">
    ...
    var Account_list = {{ account_list|tojson }};
...
<p align="left" style="background-color:#fff9c4;font-size:20px;text-align: left;"><strong> &nbsp群組消費統計</strong></p>
      <canvas id="popChart" width="600" height="400"></canvas> 
    <script>
var popCanvas = $("#popChart"); 
var popCanvas = document.getElementById("popChart"); 
var popCanvas = document.getElementById("popChart").getContext("2d"); 
var tag_Money= {{ tagMoney|tojson }};
var tag_Category = {{ tagCategory|tojson }};
